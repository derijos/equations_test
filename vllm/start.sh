...
source /workspace/paddle_setup/.venv_vllm/bin/activate
nohup python /workspace/equations_test/vllm/paddle_ocr_api.py > logs/paddle_ocr_api.log 2>&1 &
...
#     --backend-config deepseek_ocr_config.yaml \
